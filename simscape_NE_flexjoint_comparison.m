...
q0 = [0.5;-0.22;0.06]; % initial joint position
qdot0 = [0.01;0.02;-0.015]; % initial joint speed
T = 30; % simulation time
taustep = [1;-1.4;0.7];
qm0 = N.*q0; % Assume spring is unwound at time t = 0
qmdot0 = N.*qdot0;
...
% Run simulation
sim('simscape_3link_flexjoint_sim.slx')
figure(1)
for k = 1:3
    subplot(1,3,k)
...
% Run NE
sim('NE_3link_flexjoint_sim.slx')
figure(1)
for k = 1:3
    subplot(1,3,k)
